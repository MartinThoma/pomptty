...
pub struct ColorPalette {
    ...
    /// The cursor's fill color. Falls back to `foreground` when unset by the
    /// caller (pomptty always sets it explicitly, defaulting the same way).
    pub cursor: String,
    pub black: String,
    pub red: String,
    pub green: String,
